...
# @a2ml-metadata begin
# (
#   id                   = "canonical-ums-launcher"
#   type                 = "launcher"
#   version              = "0.1.0"
#   app-name             = "canonical-ums"
...
#
# ============================================================================
# canonical-ums-launcher.sh — IDApTIK Universal Modding Studio
# ============================================================================
# GENERATED by launch-scaffolder from canonical-ums.launcher.a2ml.
...
CONFIG_FILE="/home/hyperpolymath/developer/meta-repos/canonical-ums/canonical-ums.launcher.a2ml"

URL="http://localhost:4000"
APP_PORT="4000"
WAIT_SECONDS="30"

PID_FILE="${XDG_RUNTIME_DIR:-${TMPDIR:-/tmp}}/canonical-ums.pid"
LOG_FILE="${XDG_STATE_HOME:-$HOME/.local/state}/canonical-ums/ums.log"
...
[runtime].startup-command-search or [runtime].command in canonical-ums.launcher.a2ml."
            return 1
        fi
    fi
